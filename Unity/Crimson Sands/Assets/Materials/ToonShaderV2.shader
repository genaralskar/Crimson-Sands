// Upgrade NOTE: upgraded instancing buffer 'ToonShaderV2' to new syntax.
...
Shader "ToonShaderV2"
{
	...
	SubShader
	{
		...
		UNITY_INSTANCING_BUFFER_START(ToonShaderV2)
			UNITY_DEFINE_INSTANCED_PROP(float4, _Albedo_ST)
#define _Albedo_ST_arr ToonShaderV2
			UNITY_DEFINE_INSTANCED_PROP(float4, _Normal_ST)
#define _Normal_ST_arr ToonShaderV2
		UNITY_INSTANCING_BUFFER_END(ToonShaderV2)
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float2 temp_cast_0 = ((normal_lightDir8*_ScaleAndOffset + _ScaleAndOffset)).xx;
			float4 Shadow14 = ( ( Albedo28 * tex2D( _ToonRamp, temp_cast_0 ) ) * _ToonIntensity );
			...
			float3 DiffuseColor70_g7 = ( ( ( max( ( LightWrapVector47_g7 + ( ( 1.0 - LightWrapVector47_g7 ) * NDotL21_g7 ) ) , float3(0,0,0) ) * AttenuationColor8_g7 ) + (UNITY_LIGHTMODEL_AMBIENT).rgb ) * temp_cast_2 );
			...
			float4 RimLight49 = ( float4( saturate( ( pow( ( 1.0 - saturate( ( normal_viewDir9 + _RimOffset ) ) ) , _RimPower ) * ( ( DiffuseColor70_g7 + specularFinalColor42_g7 ) + normal_lightDir8 ) ) ) , 0.0 ) * ( ase_lightColor * _RimTint ) );
...
/*ASEBEGIN
Version=17101
85;368;1906;1005;-1313.059;-1033.033;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;68;-570.2838,1895.684;Float;False;Property;_SpecCoverage;Spec Coverage;15;0;Create;True;0;0;False;0;0.5;0.232;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;26;572.8464,-640.0615;Float;False;Property;_Tint;Tint;12;0;Create;True;0;0;False;0;0,0,0,0;0.7264151,0.7264151,0.7264151,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;24;497.6761,-437.9059;Inherit;True;Property;_Albedo;Albedo;11;0;Create;True;0;0;False;0;None;d721f87dbccb7fc459981cb437f16695;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;75;579.5939,2016.421;Float;False;Property;_SpecIntensity;Spec Intensity;17;0;Create;True;0;0;False;0;0.5;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;90;1021.683,-569.8273;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.CommentaryNode;29;558.5024,-702.3755;Inherit;False;849.7145;490.3647;Albedo;1;28;Albedo;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;17;-1066.711,-628.6212;Float;False;Property;_ScaleAndOffset;Scale And Offset;9;0;Create;True;0;0;False;0;0.5;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;28;1266.789,-591.2961;Float;True;Albedo;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;13;-559.5604,-622.2703;Inherit;True;Property;_ToonRamp;Toon Ramp;7;0;Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;157;32.45058,1231.626;Inherit;False;78;Spec;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;161;27.4476,1384.772;Inherit;False;Property;_LightWrap;Light Wrap;21;0;Create;True;0;0;False;0;0;0;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.LightAttenuation;162;-16.96198,1053.939;Inherit;False;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;137;-358.4609,-403.2377;Inherit;False;Property;_ToonIntensity;Toon Intensity;19;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;47;285.6777,891.6802;Float;False;Property;_RimPower;Rim Power;14;0;Create;True;0;0;False;0;0;0.092;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;52;789.5577,1164.727;Float;False;Property;_RimTint;Rim Tint;16;0;Create;True;0;0;False;0;0.1131185,0.7239776,0.7735849,0;0.1131184,0.7239776,0.7735849,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;140;1730.007,1152.638;Inherit;False;28;Albedo;1;0;OBJECT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;174;2078.059,1219.033;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.CommentaryNode;19;2140.849,1112.145;Inherit;False;506.2102;482;Output;2;99;88;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;135;-99.86516,3519.874;Inherit;False;Property;_CutoffRamp;Cutoff Ramp;6;0;Create;True;0;0;False;0;0;0;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;128;-402.6953,3182.858;Inherit;False;Property;_UVLerp;UVLerp;4;0;Create;True;0;0;False;0;0.12;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;88;2187.44,1390.488;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;124;-743.0463,2671.449;Inherit;True;Property;_DissolveTexture;Dissolve Texture;3;0;Create;True;0;0;False;0;bcb8a8d20459e6349bf5cfce27e04e22;None;False;white;Auto;Texture2D;0;1;SAMPLER2D;0
Node;AmplifyShaderEditor.RangedFloatNode;172;-1330.04,4301.116;Inherit;False;InstancedProperty;_FadeSlider;Fade Slider;2;0;Create;True;0;0;False;0;1;0;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;163;-1733.041,4013.856;Inherit;False;Property;_Vector2;Vector 2;5;0;Create;True;0;0;False;0;0,0;2,7;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;121;-1032.319,2997.309;Inherit;False;Property;_Speed;Speed;8;0;Create;True;0;0;False;0;0.1,0.1;0.1,0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
WireConnection;174;0;140;0
WireConnection;174;1;61;0
...
ASEEND*/
//CHKSM=5277225D8C766A388ED788B47728DF1537773F2E