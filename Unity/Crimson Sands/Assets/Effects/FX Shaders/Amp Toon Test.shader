...
Shader "Smoke Noise Toon"
{
	Properties
	{
		...
		[KeywordEnum(Key0,Key1)] _Keyword0("Keyword 0", Float) = 0
	...
	SubShader
	{
		...
		#pragma multi_compile _KEYWORD0_KEY0 _KEYWORD0_KEY1
		struct Input
		{
			float2 uv_texcoord;
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			Input i = s.SurfInput;
			half4 c = 0;
			float mulTime255 = _Time.y * 0.01;
			float2 panner254 = ( mulTime255 * float2( 1,0 ) + float2( 0,0 ));
			float2 uv_TexCoord253 = i.uv_texcoord * float2( 0.05,0.5 ) + panner254;
			float simplePerlin2D252 = snoise( uv_TexCoord253*10.0 );
			simplePerlin2D252 = simplePerlin2D252*0.5 + 0.5;
			float NoiseTex189 = simplePerlin2D252;
			float cameraDepthFade237 = (( i.eyeDepth -_ProjectionParams.y - _Offset ) / _Length);
			#if defined(_KEYWORD0_KEY0)
				float staticSwitch251 = cameraDepthFade237;
			#elif defined(_KEYWORD0_KEY1)
				float staticSwitch251 = 0.0;
			#else
				float staticSwitch251 = cameraDepthFade237;
			#endif
			float TextureMask131 = ( ( NoiseTex189 - ( ( 1.0 - i.vertexColor.a ) * _CutoffRamp ) ) + staticSwitch251 );
			c.rgb = 0;
			c.a = 1;
		...
		ENDCG
		CGPROGRAM
		#pragma surface surf StandardCustomLighting keepalpha fullforwardshadows noshadow noambient novertexlights 
...
/*ASEBEGIN
Version=17101
179;362;1514;576;3473.818;-977.0118;4.181541;True;True
Node;AmplifyShaderEditor.SimpleTimeNode;255;-2229.724,3381.666;Inherit;False;1;0;FLOAT;0.01;False;1;FLOAT;0
Node;AmplifyShaderEditor.PannerNode;254;-2008.539,3331.677;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;1,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;253;-1793.57,3249.493;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;0.05,0.5;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.NoiseGeneratorNode;252;-1536.862,3226.379;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;10;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;135;786.1779,3906.979;Inherit;False;Property;_CutoffRamp;Cutoff Ramp;5;0;Create;True;0;0;False;0;0;1.055;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;239;720.023,3288.655;Inherit;False;Property;_Offset;Offset;27;0;Create;True;0;0;False;0;0;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;238;717.294,3195.858;Inherit;False;Property;_Length;Length;26;0;Create;True;0;0;False;0;0;20;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CameraDepthFade;237;977.944,3191.764;Inherit;False;3;2;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;178;817.0332,3508.027;Inherit;False;189;NoiseTex;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;251;1326.391,3307.042;Inherit;False;Property;_Keyword0;Keyword 0;28;0;Create;True;0;0;True;0;1;0;0;True;;KeywordEnum;2;Key0;Key1;Create;False;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WorldNormalVector;224;-979.2918,3572.495;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;213;-2584.63,3446.325;Inherit;False;Property;_FadeSlider;Fade Slider;1;0;Create;True;0;0;False;0;1.231126;4.08;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;52;789.5577,1164.727;Float;False;Property;_RimTint;Rim Tint;17;0;Create;True;0;0;False;0;0.1131185,0.7239776,0.7735849,0;0.9245283,0.8678355,0.871885,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;26;572.8464,-640.0615;Float;False;Property;_Tint;Tint;13;0;Create;True;0;0;False;0;0,0,0,0;0.5849056,0.5849056,0.5849056,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;17;-1036.811,-632.5211;Float;False;Property;_ScaleAndOffset;Scale And Offset;9;0;Create;True;0;0;False;0;0.5;0.795;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;47;285.6777,891.6802;Float;False;Property;_RimPower;Rim Power;15;0;Create;True;0;0;False;0;0;0.692;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;99;2411.264,1157.546;Float;False;True;7;ASEMaterialInspector;0;0;CustomLighting;Smoke Noise Toon;False;False;False;False;True;True;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Off;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Masked;0;True;True;0;False;TransparentCutout;;AlphaTest;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;False;0;1;False;-1;10;False;-1;0;1;False;-1;10;False;-1;0;False;-1;1;False;-1;0;False;0.0001;0.5,0.4292453,0.4292453,0;VertexOffset;True;False;Cylindrical;False;Absolute;0;;2;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
WireConnection;254;1;255;0
WireConnection;253;1;254;0
WireConnection;252;0;253;0
WireConnection;189;0;252;0
...
WireConnection;241;0;130;0
WireConnection;241;1;251;0
...
ASEEND*/
//CHKSM=B1A9089ECE1CB83F16DA8CB7D89AD06B421BB574