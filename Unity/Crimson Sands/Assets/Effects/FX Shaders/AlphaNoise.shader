...
Shader "AlphaNoise"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 tex2DNode16 = tex2D( _DissolveTexture, panner22 );
			c.rgb = 0;
			c.a = 1;
			clip( ( tex2DNode16.r - _Mask ) - _Cutoff );
			return c;
		}
...
/*ASEBEGIN
Version=17101
0;585;1267;536;3739.059;643.4525;1.783566;True;True
...
Node;AmplifyShaderEditor.TexturePropertyNode;15;-2777.054,-92.50512;Inherit;True;Property;_DissolveTexture;Dissolve Texture;1;0;Create;True;0;0;False;0;bcb8a8d20459e6349bf5cfce27e04e22;None;False;white;Auto;Texture2D;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;33;-1646.461,361.3824;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=C30D72610275967B29C117C29705A088772AC2F5