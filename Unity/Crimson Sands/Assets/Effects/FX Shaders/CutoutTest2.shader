...
Shader "CutoutTest2"
{
	Properties
	{
		...
		_CutoffPower("Cutoff Power", Range( 0 , 1)) = 1
		_CutoffAccelerator("Cutoff Accelerator", Range( 0 , 10)) = 0
	...
	SubShader
	{
		...
		uniform float _CutoffAccelerator;
		uniform float _CutoffPower;
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			#endif
			float temp_output_146_0 = pow( i.vertexColor.a , _CutoffPower );
			...
			float3 temp_cast_1 = (normal_viewDir71).xxx;
			...
			float4 temp_cast_3 = (normal_lightDir64).xxxx;
			float3 worldSpaceViewDir125 = WorldSpaceViewDir( temp_cast_3 );
			float dotResult136 = dot( normalize( (WorldNormalVector( i , temp_cast_1 )) ) , worldSpaceViewDir125 );
			float2 uv_TextureSample0 = i.uv_texcoord * _TextureSample0_ST.xy + _TextureSample0_ST.zw;
			float4 blendOpSrc149 = float4( 1,1,1,1 );
			float4 blendOpDest149 = ( ( _CutoffAccelerator * temp_output_146_0 ) * ( dotResult136 * tex2D( _TextureSample0, uv_TextureSample0 ) ) );
			float4 lerpBlendMode149 = lerp(blendOpDest149,( 1.0 - ( 1.0 - blendOpSrc149 ) * ( 1.0 - blendOpDest149 ) ),temp_output_146_0);
			float4 AlphaCutoff54 = ( saturate( lerpBlendMode149 ));
			float4 temp_output_55_0 = AlphaCutoff54;
			float2 uv_Albedo = i.uv_texcoord * _Albedo_ST.xy + _Albedo_ST.zw;
			float4 Albedo43 = ( i.vertexColor * ( _Tint * tex2D( _Albedo, uv_Albedo ) ) );
			float2 temp_cast_6 = ((normal_lightDir64*_ScaleandOffset + _ScaleandOffset)).xx;
			float4 Shadow52 = ( Albedo43 * tex2D( _ToonRamp, temp_cast_6 ) );
...
/*ASEBEGIN
Version=17101
874;72.66667;1044;1049;2941.02;-3538.523;1.281987;True;False
Node;AmplifyShaderEditor.SamplerNode;65;-3246.048,722.6817;Inherit;True;Property;_Normal;Normal;3;0;Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;38;-1999.368,-423.8665;Inherit;True;Property;_Albedo;Albedo;2;0;Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;39;-2004.198,-620.308;Float;False;Property;_Tint;Tint;5;0;Create;True;0;0;False;0;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;47;-2302.52,93.60297;Float;False;Property;_ScaleandOffset;Scale and Offset;4;0;Create;True;0;0;False;0;0.5;0.488;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;85;-2807.186,1646.307;Float;False;Property;_RimOffset;Rim Offset;6;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;49;-1809.51,85.841;Inherit;True;Property;_ToonRamp;Toon Ramp;1;0;Create;True;0;0;False;0;None;7c3377ba75b009546a210fa64959e202;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;91;-2365.991,1676.146;Float;False;Property;_RimPower;Rim Power;7;0;Create;True;0;0;False;0;0;0.505;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;107;-2343.892,2594.643;Float;False;Property;_SpecCoverage;Spec Coverage;9;0;Create;True;0;0;False;0;0.5;0.401;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;148;-3084.461,4038.106;Inherit;False;64;normal_lightDir;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;53;-2860.818,3813.525;Inherit;False;1348.995;676.5421;Alpha Cutoff;12;126;136;125;139;140;142;143;146;147;149;152;153;Alpha Cutoff;1,1,1,1;0;0
Node;AmplifyShaderEditor.GetLocalVarNode;151;-3038.319,3864.939;Inherit;False;71;normal_viewDir;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;113;-1884.578,2692.104;Inherit;True;Property;_SpecMap;Spec Map;11;0;Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;94;-1862.111,1949.193;Float;False;Property;_RimTint;Rim Tint;8;0;Create;True;0;0;False;0;0.1131185,0.7239776,0.7735849,0;0.764151,0.6019492,0.6114899,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WorldSpaceViewDirHlpNode;125;-2802.561,4010.915;Inherit;True;1;0;FLOAT4;0,0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldNormalVector;126;-2771.954,3871.926;Inherit;False;True;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.VertexColorNode;143;-2327.26,3921.426;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;147;-2408.739,3844.564;Inherit;False;Property;_CutoffPower;Cutoff Power;13;0;Create;True;0;0;False;0;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;146;-2162.211,3890.341;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;152;-2409.525,3762.752;Inherit;False;Property;_CutoffAccelerator;Cutoff Accelerator;14;0;Create;True;0;0;False;0;0;0;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;115;-1194.013,2715.38;Float;False;Property;_SpecIntensity;Spec Intensity;10;0;Create;True;0;0;False;0;0.5;0.347;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;139;-2823.845,4230.518;Inherit;True;Property;_TextureSample0;Texture Sample 0;12;0;Create;True;0;0;True;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DotProductOpNode;136;-2529.697,3959.682;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;140;-2263.961,4078.874;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;153;-2024.085,3836.673;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;142;-1976.088,4055.377;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.BlendOpsNode;149;-1734.885,3920.998;Inherit;False;Screen;True;3;0;COLOR;1,1,1,1;False;1;COLOR;0,0,0,0;False;2;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;0,0;Float;False;True;6;ASEMaterialInspector;0;0;CustomLighting;CutoutTest2;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.9;True;True;0;True;TransparentCutout;;Geometry;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;0;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=4D53767121ABF3C0015090A7A46C808532368FAA